 ...
 * Верхняя граница низкая намеренно — «превращение» должно случаться
 * на самом краю отдаления, а не мешать обычному разглядыванию города.
 */
export const GLOBE_ZOOM_FULL = 1.2;
export const GLOBE_ZOOM_NONE = 3.2;
